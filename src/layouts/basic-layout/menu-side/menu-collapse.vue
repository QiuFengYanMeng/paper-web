    ...
    <Dropdown placement="right-start" :class="dropdownClasses">
        ...
        <DropdownMenu slot="list">
            <template v-for="(item, index) in menu.children">
                <i-link :to="item.path" v-if="item.children === undefined || !item.children.length" :key="index">
                    <DropdownItem :class="{ 'i-layout-menu-side-collapse-item-selected': item.path === activePath }">
