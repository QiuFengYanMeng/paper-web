            ...
            <transition name="fade-quick">
                <Header class="i-layout-header" :class="headerClasses" :style="headerStyle" v-show="showHeader" v-resize="handleHeaderWidthChange">
                    ...
                    <div class="i-layout-header-right">
                       ...
                       <!-- <i-header-log v-if="!isMobile && showLog" />-->
                        <i-header-fullscreen v-if="!isMobile && showFullscreen" />
...
<script>
    ...
    export default {
        name: 'BasicLayout',
        components: { iMenuHead, iMenuSide, iCopyright, iHeaderLogo, iHeaderCollapse, iHeaderBreadcrumb, iHeaderSearch, iHeaderUser, iHeaderLog, iHeaderFullscreen, iHeaderSetting, iHeaderNotice, iTabs },
        data () {
            return {
                showDrawer: false,
                ticking: false,
